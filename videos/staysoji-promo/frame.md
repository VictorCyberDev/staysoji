...
colors:
  ...
  text-muted: "#A9822F"
  text-light: "#9A9A9A"
  accent-light: "rgba(201, 162, 75, 0.08)"
  accent-medium: "rgba(201, 162, 75, 0.15)"
  border: "rgba(201, 162, 75, 0.2)"
  card-bg: "rgba(201, 162, 75, 0.04)"
  positive: "#059669"
  negative: "#dc2626"
...
typography:
  ...
  h4-eyebrow:{ fontFamily: "Geist", cqw: 0.8, weight: 500, tracking: "0.08em", upper: true, color: "primary" }
  ...
  stat-num:{ fontFamily: "Geist", cqw: 1.9, weight: 500, lineHeight: 1.0, color: "primary" }
  blockquote:{ fontFamily: "Geist", cqw: 2.4, weight: 500, lineHeight: 1.35, color: "text" }
  h2:      { fontFamily: "Geist", cqw: 2.6, weight: 500, lineHeight: 1.1, tracking: "-0.02em", color: "text" }
  metric-value:{ fontFamily: "Geist", cqw: 3.0, weight: 500, lineHeight: 1.0, color: "primary" }
  h1:      { fontFamily: "Geist", cqw: 4.2, weight: 500, lineHeight: 1.08, tracking: "-0.02em", color: "text" }
  quote-mark:{ fontFamily: "Geist", cqw: 8.0, weight: 500, lineHeight: 0.5, color: "primary", opacity: 0.15 }
...
- **Weights** — the brand font ships `{400, 500}` only; every weight is clamped to these — ignore higher preset weights (e.g. 600/700) in prose.
